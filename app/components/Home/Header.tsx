        ...
        <div className='flex flex-col md:flex-row gap-3'>
          <Link
            ...
            <div className='hidden md:block absolute top-14 -left-5 rotate-45'>
              ...
              <p className={`${permanentMarker.className} text-xs`}>For individuals</p>
            </div>
          </Link>
          ...
          <Link
            ...
            <div className='hidden md:block absolute top-10 right-0 -rotate-45'>
              <Image src={'/arrow-right.svg'} width={70} height={70} alt='lock' />
              <p className={`${permanentMarker.className} text-xs`}>For Businesses</p>
            </div>
          </Link>
        </div>
      </div>
